// ignore_for_file: non_constant_identifier_names, await_only_futures, missing_return
...
class _MyProfileScreenState extends State<MyProfileScreen> {
  ...
  _getuserdata() async {
    setState(() { _loading = true; tags.clear(); });
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        value: _profession.text.isNotEmpty?_profession.text:null,
                        //elevation: 5,
                    ...
                    _profession.text == 'student'?Container(
                      margin: EdgeInsets.symmetric(horizontal: 15, vertical: 10),
                      child: TextFormField(
                        controller: _collage_name,
                        style: mediumTextStyle().copyWith(color: konDarkColorB1),
                        decoration: textFormFieldInputDecoration('Collage Name'),
                      ),
                    ):SizedBox(),
                    _profession.text == 'student'?Container(
                      margin: EdgeInsets.symmetric(horizontal: 15, vertical: 10),
                      child: TextFormField(
                        controller: _degree,
                        style: mediumTextStyle().copyWith(color: konDarkColorB1),
                        decoration: textFormFieldInputDecoration('Degree'),
                      ),
                    ):SizedBox(),
                    _profession.text == 'student'?Container(
                      margin: EdgeInsets.symmetric(horizontal: 15, vertical: 10),
                      child: TextFormField(
                        ...
                        style: mediumTextStyle().copyWith(color: konDarkColorB1),
                        decoration: textFormFieldInputDecoration('Year of Study'),
                      ),
                    ):SizedBox(),
                    _profession.text == 'working'?Container(
                        margin: EdgeInsets.symmetric(horizontal: 15, vertical: 10),
                        child: TextFormField(
                          controller: _yearofexperience,
                          style: mediumTextStyle().copyWith(color: konDarkColorB1),
                          decoration: textFormFieldInputDecoration('Year of Experience'),
                        ),
                      ):SizedBox(),
                    _profession.text == 'working'?Container(
                        margin: EdgeInsets.symmetric(horizontal: 15, vertical: 10),
                        child: TextFormField(
                          ...
                          style: mediumTextStyle().copyWith(color: konDarkColorB1),
                          decoration: textFormFieldInputDecoration('Designation'),
                        ),
                      ):SizedBox(),
                    _profession.text == 'working'?Container(
                        margin: EdgeInsets.symmetric(horizontal: 15, vertical: 10),
                        child: DropdownButtonFormField<String>(
                          ...
                          focusColor:Colors.white,
                          value: _qualification.text.isNotEmpty?_qualification.text:null,
                          //elevation: 5,
                          style: TextStyle(color: Colors.white),
                          iconEnabledColor:Colors.black,
                          items: <String>[
                    ...
                    _profession.text == 'working'?Container(
                        ...
                        child: TextFormField(
                          ...
                          style: mediumTextStyle().copyWith(color: konDarkColorB1),
                          decoration: textFormFieldInputDecoration('Major In'),
                        ),
                      ):SizedBox(),
                    Container(
                      margin: EdgeInsets.symmetric(horizontal: 15, vertical: 10),
                      child: TextFieldTags(
                          ...
                          tagsStyler: TagsStyler(
                              ...
                              tagDecoration: BoxDecoration(color: Colors.grey.withOpacity(0.6), borderRadius: BorderRadius.circular(30.0), ),
