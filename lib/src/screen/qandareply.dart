// ignore_for_file: non_constant_identifier_names, deprecated_member_use, dead_code, unused_local_variable
...
class _QandAReplyScreenState extends State<QandAReplyScreen> {
  ...
  //recording
  List<QandAReply> _reply = new List<QandAReply>();
  ...
  _fetchreply() async {
    ...
    var res = await ctrl.getrequestwithheader('qanda_reply/' + widget.data['question_id']);
    if (!mounted) return;
    setState(() {
      _reply.clear();
      load_qanda = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.white,
        title: !load_qanda?Text (_reply.length.toString()+' Replies', style: TextStyle(color: konBlackColor)):Text ('Replies', style: TextStyle(color: konBlackColor)),
      ),
      body: LoadingOverlay(
        color: Colors.white,
        isLoading: _loading,
        child:  Container(
          child: SingleChildScrollView(
            child: _reply.length != 0 && !load_qanda?Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Container(
            ...
            ):_reply.length == 0 && !load_qanda?Container(
              child: Align(
                  alignment: Alignment.center,
                  child: Column(
                    children: [
