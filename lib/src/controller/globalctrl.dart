...
Future addtocart(courseId,context) async {
  print(courseId);
  var res = await requestwithheader({'courseId': courseId }, 'toggle_cart');
  print(res);
...
Future addtowishlist(courseId) async {
  var res = await requestwithheader({'courseId': courseId }, 'toggle_wishlist');
  return true;
}